  ...
  public static void main(String[] args) throws Exception {
    ...
    try (
        java.sql.Connection con =
            DriverManager.getConnection("jdbc:mariadb://localhost:3306/jsh?user=jo&password=1111");
      ...
      //
      int count = stmt.executeUpdate("insert into x_board(title,contents) values('제몲ㄹ','마라이')");
